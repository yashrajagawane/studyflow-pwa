  ...
  return (
    <div className="settings-page">
      ...
      <section className="settings-grid">
        ...
        <article className="panel settings-card"><div className="settings-icon">⌂</div><div><p className="card-kicker">YOUR DATA</p><h3>Stored on this device</h3><p>Your data is saved locally in this browser. If you sign in and choose Sync now, a copy is also stored securely in your Supabase account.</p><span className="settings-version">{taskCount} tasks · {sessionCount} sessions</span></div></article>
      </section>
